...
<head>
    ...
    <meta name="description" content="NHC Cleaning and Technical " />
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
        ...
        <section class="banner-one">
            <div class="banner-one__shape-bg-1"
                style="background-image: url(assets/images/shapes/banner-one-shape-bg-1.png);"></div>
                        ...
                        <div class="banner-one__left">
                            ...
                            <div class="banner-one__satisfied-partner">
                                ...
                                <div class="banner-one__satisfied-partner-content">
                                    ...
                                    <p class="banner-one__satisfied-partner-text">Satisficed Partners</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="banner-one__img-box">
                                ...
                                <div class="banner-one__google-rating">
                                    <div class="banner-one__google-rating-img">
                                        <img src="assets/images/resources/banner-one-google-rating-img.png" alt="">
                                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-6">
                        ...
                        <h2 class="about-one__left-big-title wow fadeInLeft" data-wow-delay="300ms"
                            data-wow-duration="1500ms">NHC Cleaning and Technical</h2>
                    </div>
                    <div class="col-xl-6">
        ...
        <section class="sliding-text-two">
            <div class="sliding-text-one__wrap">
                <ul class="sliding-text-two__list list-unstyled marquee_mode">
                    <li>
                        <h2 data-hover="Organizing" class="sliding-text-two__title">Organizing
                            <img src="assets/images/shapes/sliding-text-shape-1.png" alt=""></h2>
                    </li>
                    <li>
                        <h2 data-hover="Sanitizing" class="sliding-text-two__title">Sanitizing
                            <img src="assets/images/shapes/sliding-text-shape-1.png" alt=""></h2>
                    </li>
                    <li>
                        <h2 data-hover="Mopping" class="sliding-text-two__title">Mopping
                            <img src="assets/images/shapes/sliding-text-shape-1.png" alt=""></h2>
                    </li>
                    <li>
                        <h2 data-hover="Dusting" class="sliding-text-two__title">Dusting
                            <img src="assets/images/shapes/sliding-text-shape-1.png" alt=""></h2>
                    </li>
                    <li>
                        <h2 data-hover="Vacuuming" class="sliding-text-two__title">Vacuuming
                            <img src="assets/images/shapes/sliding-text-shape-1.png" alt=""></h2>
                    </li>
                    <li>
                        <h2 data-hover="Polishing" class="sliding-text-two__title">Polishing
                            <img src="assets/images/shapes/sliding-text-shape-1.png" alt=""></h2>
                    </li>
                </ul>
            </div>
                    ...
                    <li class="col-xl-3 col-lg-6 col-md-6">
                        <div class="counter-one__single">
                            ...
                            <div class="counter-one__content">
                                ...
                                <p class="counter-one__count-text">Projects Done per month </p>
                            </div>
                        </div>
                    </li>
                    <li class="col-xl-3 col-lg-6 col-md-6">
...
<?php //include "views/partials/blog.php"?>
                                    ...
                                    <div class="site-footer__contact-info-box">
                                        ...
                                        <ul
                                            ...
                                            <li>
                                                ...
                                                <div class="site-footer__contact-info-content">
                                                    <p>Email Address:</p>
                                                    <h5><a href="mailto:info@domain.com">info@nhccleaningandtechnical.com</a></h5>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="site-footer__contact-info-icon">
                                                ...
                                                <div class="site-footer__contact-info-content">
                                                    <p>Phone Number:</p>
                                                    <h5><a href="tel:9288006780">+971 52 650 3468</a></h5>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-4">
                                                <div class="footer-widget__essential-links">
                                                    ...
                                                    <ul class="footer-widget__quick-links-list list-unstyled">
                                                        <li><a href="about.html"> <span class="icon-next"></span>
                                                                Our Company</a>
                                                        </li>
                                                        <li><a href="about.html"> <span class="icon-next"></span> Terms
                                                                & Condition</a></li>
                                                        <li><a href="about.html"> <span class="icon-next"></span>
                                                                Privacy Policy</a></li>
                                                        <li><a href="contact.html"> <span class="icon-next"></span>
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-4">
                                                <div class="footer-widget__services-links">
                                                    ...
                                                    <ul class="footer-widget__quick-links-list list-unstyled">
                                                        <li><a href="office-cleaning.html"> <span
                                                                    class="icon-next"></span>
                                                                Office Cleaning</a>
                                                        </li>
                                                        <li><a href="commercial-cleaning.html"> <span
                                                                    class="icon-next"></span> House
                                                                Cleanings</a></li>
                                                        <li><a href="sanitizing-mopping.html"> <span
                                                                    class="icon-next"></span>
                                                                Store Moping</a></li>
                                                        <li><a href="deep-cleaning.html"> <span
                                                                    class="icon-next"></span>
                                                                Organization</a>
                                                        </li>
                                                        <li><a href="residential-cleaning.html"> <span
                                                                    class="icon-next"></span>
                                                                Room Sparkling</a></li>
                                                    </ul>
                                                </div>
                            ...
                            <div class="col-xl-6 col-lg-6">
                                <div class="site-footer__bottom-text-box">
                                    <p class="site-footer__bottom-text">Copyright © 2025 by <a
                                            href="https://themeforest.net/user/codearchives">NHC Cleaning and Technical.</a> All
                                        rights reserved.</p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="mobile-nav__content">
            ...
            <ul class="mobile-nav__contact list-unstyled">
                <li>
                    ...
                    <a href="mailto:needhelp@packageName__.com">needhelp@NHC Cleaning and Technical.com</a>
                </li>
                <li>
